        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div class="lg:col-span-6 text-center lg:text-left flex flex-col items-center lg:items-start">
                ...
                <p class="text-base sm:text-lg text-slate-600 max-w-xl mb-8 leading-relaxed font-sans">
                    Handmade 925 sterling silver rings set with authentic, certified gemstones. Custom crafted to represent your spiritual identity and timeless style.
                </p>
                ...
                <div class="mt-12 pt-8 border-t border-slate-200 w-full grid grid-cols-3 gap-4 text-center lg:text-left">
                    <div>
                        <div class="text-2xl font-serif font-bold text-amber-600">100%</div>
                        <div class="text-xs text-slate-500 mt-1 uppercase tracking-wider font-semibold">Certified Stones</div>
                    </div>
                    <div>
                        <div class="text-2xl font-serif font-bold text-amber-600">925</div>
                        <div class="text-xs text-slate-500 mt-1 uppercase tracking-wider font-semibold">Pure Silver</div>
                    </div>
                    <div>
                        <div class="text-2xl font-serif font-bold text-amber-600">Free</div>
                        <div class="text-xs text-slate-500 mt-1 uppercase tracking-wider font-semibold">Insured Shipping</div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-6 flex justify-center relative">
                ...
                <div class="relative group max-w-md w-full rounded-2xl overflow-hidden border border-slate-200/80 bg-white p-4 shadow-xl shadow-slate-200/50">
                    <div class="relative aspect-square rounded-xl overflow-hidden bg-slate-50 border border-slate-200/50">
                        <img src="{{ asset('images/ring_hero.png') }}" alt="Noor Al Khatam Yemeni Aqeeq Ring" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                        ...
                        <div class="absolute bottom-4 left-4 bg-slate-900/95 border border-amber-500/30 px-3.5 py-1.5 rounded-lg backdrop-blur-sm">
                            <span class="text-[10px] font-mono tracking-widest text-amber-400 uppercase">Yemeni Red Aqeeq</span>
                        </div>
                    </div>
                    
                    <div class="mt-4 px-2 py-1 flex justify-between items-center">
                        <div>
                            <h3 class="font-serif text-slate-900 font-semibold tracking-wide">The Royal Al-Khatam</h3>
                            <p class="text-xs text-slate-500 mt-1 font-sans">Custom hand filigree & floral side etching</p>
                        </div>
                        <div class="text-right">
                            <span class="text-sm font-mono text-amber-600 font-semibold">$349</span>
                            <p class="text-[9px] text-emerald-600 font-semibold mt-0.5 uppercase tracking-wider">In Stock</p>
                        </div>
                    </div>
                </div>
            </div>
